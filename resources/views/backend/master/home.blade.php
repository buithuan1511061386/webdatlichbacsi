...
@section('head')
 <meta charset="UTF-8">
    ...
    <!-- end of global css -->
    <!--page level css -->
    <link href="{{asset('public/backend/vendors/fullcalendar/css/fullcalendar.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/backend/css/pages/calendar_custom.css')}}" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" media="all" href="{{asset('public/backend/vendors/bower-jvectormap/css/jquery-jvectormap-1.2.2.css')}}" />
    <link rel="stylesheet" href="{{asset('public/backend/vendors/animate/animate.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('public/backend/vendors/datetimepicker/css/bootstrap-datetimepicker.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/backend/css/pages/only_dashboard.css')}}" />
...
<!-- global js -->
    ...
    <!-- EASY PIE CHART JS -->
    <script src="{{asset('public/backend/vendors/jquery.easy-pie-chart/js/easypiechart.min.js')}}"></script>
    <script src="{{asset('public/backend/vendors/jquery.easy-pie-chart/js/jquery.easypiechart.min.js')}}"></script>
    <script src="{{asset('public/backend/js/jquery.easingpie.js')}}"></script>
    <!--end easy pie chart -->
    <!--for calendar-->
    <script src="{{asset('public/backend/vendors/moment/js/moment.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('public/backend/vendors/fullcalendar/js/fullcalendar.min.js')}}" type="text/javascript"></script>
    <!--   Realtime Server Load  -->
    <script src="{{asset('public/backend/vendors/flotchart/js/jquery.flot.js')}}" type="text/javascript"></script>
    <script src="{{asset('public/backend/vendors/flotchart/js/jquery.flot.resize.js')}}" type="text/javascript"></script>
    <!--Sparkline Chart-->
    <script src="{{asset('public/backend/vendors/sparklinecharts/jquery.sparkline.js')}}"></script>
    <!-- Back to Top-->
    <script type="text/javascript" src="{{asset('public/backend/vendors/countUp.js/js/countUp.js')}}"></script>
    <!--   maps -->
    <script src="{{asset('public/backend/vendors/bower-jvectormap/js/jquery-jvectormap-1.2.2.min.js')}}"></script>
    <script src="{{asset('public/backend/vendors/bower-jvectormap/js/jquery-jvectormap-world-mill-en.js')}}"></script>
    <script src="{{asset('public/backend/vendors/chartjs/Chart.js')}}"></script>
    <script type="text/javascript" src="{{asset('public/backend/vendors/datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
    <!--  todolist-->
    <script src="{{asset('public/backend/js/pages/todolist.js')}}"></script>
    <script src="{{asset('public/backend/js/pages/dashboard.js')}}" type="text/javascript"></script> 
