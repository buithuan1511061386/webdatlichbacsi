                                    ...
                                    <span class="fileinput-new">Select image</span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <option value="{{$item->id}}" {{ $item->id == $data->region_id ? 'selected="selected"' : '' }}>{{$item->name}}</option>
                                                    @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="region" class="col-sm-2 control-label">Hospital</label>
                                                    <div class="col-md-10">
                                                        <select class="select21 form-control" name="hospital_id" id="hospital_id">
                                                            <option disabled selected>Select Hospital</option>
                                                           @foreach($hospital as $item)
                                                        <option value="{{$item->id}}" {{ $item->id == $data->hospital_id ? 'selected="selected"' : '' }}>{{$item->name}}</option>
                                                    @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="region" class="col-sm-2 control-label">Department</label>
                                                    <div class="col-md-10">
                                                        <select class="select21 form-control" name="department_id" id="department_id">
                                                            <option disabled selected>Select Department</option>
                                                           @foreach($department as $item)
                                                        <option value="{{$item->id}}" {{ $item->id == $data->department_id ? 'selected="selected"' : '' }}>{{$item->name}}</option>
                                                    @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="price" name="price" type="text" placeholder="Price" class="form-control" value="{{ $data->price}}" />
                                                    </div>
                                                </div>
                                                           <div class="form-group">
                                                    <label for="latitude" class="col-sm-2 control-label">Latitude </label>
                                                    <div class="col-sm-10">
                                                        <input id="latitude" name="latitude" type="text" class="form-control" value="{{ $data->latitude}}" />
                                                    </div>
                                                </div>
                                                    <div class="form-group">
                                                    <label for="longitude" class="col-sm-2 control-label">Longitude </label>
                                                    <div class="col-sm-10">
                                                        <input id="longitude" name="longitude" type="text" class="form-control" value="{{ $data->longitude}}" />
                                                    </div>
                                                </div>
