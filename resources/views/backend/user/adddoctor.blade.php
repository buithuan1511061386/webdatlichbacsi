                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Add New Doctor
                                </h3>
									...
									{{csrf_field()}}
									   <fieldset>
                                        ...
                                        <div class="form-group hidden">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="user_level_id" name="user_level_id" type="text" class="form-control" value="2"  />
                                                    </div>
                                                </div>
