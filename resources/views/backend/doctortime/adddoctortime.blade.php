                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <!-- errors -->
                                <!--main content-->
                                <form id="commentForm" action="{{route('admin.doctortime.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                                    <!-- CSRF Token -->
									{{csrf_field()}}
									   <fieldset>
                                        <!-- Name input-->
                                        ...
                                        <div class="form-group required">
                                            <label for="dob" class="col-sm-2 control-label">Date</label>
                                                <div class="col-sm-10">
                                                    <input id="dob" name="date" type="text" class="form-control" data-date-format="YYYY-MM-DD" placeholder="yyyy-mm-dd" />
                                                    </div>
                                        </div>
                                            <div class="form-group required">
