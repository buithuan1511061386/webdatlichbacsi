...
@section('head')
    ...
    <link href="{{asset('public/backend/vendors/fullcalendar/css/fullcalendar.print.css')}}" rel="stylesheet" media='print' type="text/css">
...
@section('bottom')
    ...
    <script src="{{asset('public/backend/js/pages/calendar.js')}}" type="text/javascript"></script>
