									   ...
									   <fieldset>
                                        <!-- Name input-->
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="name" name="title" type="text" placeholder="Title" class="form-control" required value="{{$data->title}}" />
                                                    </div>
                                                </div>
												 <div class="form-group">
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <option value="{{$item->id}}" {{ $item->id == $data->typeofnews_id ? 'selected="selected"' : '' }}>{{$item->name}}</option>
                                                    @endforeach
                                                        </select>
                                                    </div>
                                                </div>
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="link" name="link" type="text" placeholder="Link" class="form-control" value="{{$data->link}}" />
                                                    </div>
                                                </div>
												                                   <div class="form-group">
												...
												<div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input id="meta_desc" name="meta_desc" type="text" placeholder="Meta desc" class="form-control" value="{{$data->meta_desc}}" />
                                                    </div>
                                                </div>
												<div class="form-group">
                                                    <label for="title" class="col-sm-2 control-label">Meta key</label>
                                                    <div class="col-sm-10">
                                                        <input id="meta_key" name="meta_key" type="text" placeholder="Meta desc" class="form-control" value="{{$data->meta_key}}"/>
                                                    </div>
                                                </div>
