                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <!-- errors -->
                                <!--main content-->
                                <form id="commentForm" action="{{route('admin.region.store')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" >
                                    <!-- CSRF Token -->
									{{csrf_field()}}
									   <fieldset>
                                        <!-- Name input-->
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input id="name" name="name" type="text" placeholder="Region name" class="form-control"></div>
                                        </div>

                                        <!-- Form actions -->
                                        <div class="form-group">
                                            <div class="col-md-12 text-right">
                                                <button type="submit" name="btnAddRegion"class="btn btn-responsive btn-primary btn-sm">Submit</button>
                                            </div>
                                        </div>
                                    </fieldset>
                                </form>
