...
@section('head')
    <meta charset="UTF-8">
    <title>Edit Region | Josh Admin Template</title>
                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> Edit Region
                                </h3>
                            ...
                            <div class="panel-body">
                                <!-- errors -->
                                <!--main content-->
                                <form id="commentForm" method="POST" enctype="multipart/form-data" class="form-horizontal" action="{{route('admin.region.update_post',$data->id)}}">
                                    ...
                                    <!-- CSRF Token -->
									   ...
									   <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="name">Region Name</label>
                                            <div class="col-md-9">
                                                <input id="name" name="name" type="text" placeholder="Region name" class="form-control" value="{{ $data->name }}"></div>
                                        </div>
