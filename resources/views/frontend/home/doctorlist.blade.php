...
<body>
    <div class="container">
        <h1 style="text-transform: uppercase;">CÁC BÁC SĨ GẦN BẠN:
        <div id="product">
                            ...
                            "<div class='prod-info-main prod-wrap clearfix'>"+
                                "<div class='row'>"+
                                        ...
                                        "<div class='product-deatil'>"+
                                                "<h5 class='name'>"+
                                        "<a href='home/"+index.people.id+"/show'>"+index.people.name+"</a>"+
                                                "</h5>"+
                                                "<p class='price-container'>"+
                                                    "<span>"+index.people.price.toLocaleString('it-IT', {style : 'currency', currency : 'VND'})+"</span>"+
                                                "</p>"+
                                                "<p class='price-container'>Cách khoản: "+parseFloat(index.dist*2).toFixed(2)+" Km</p>"+
                                                "<a href='home/"+index.people.id+"/show' class='btn btn-info'>More info</a>"+
