                        ...
                        <div class="item active">
                            ...
                            <div class="col-md-6 col-sm-6 no-padding">
                                <div class="banner-right">
                                    <img src="{{asset('public/frontend/images/banner-main.png')}}" alt="banner-main"/>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',4)}}">Pulmonary</a></h5>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',5)}}">Cardiology</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',6)}}">Traumatology</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',7)}}">Neurology</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',8)}}">X-ray</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',9)}}">Nuclear magnetic</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',10)}}">Diagnostic</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-6 no-padding">
                    <div class="what-we-do-block">
                        ...
                        <div class="what-we-do-block-content">
                            ...
                            <h5><a href="{{ route('site.home.departmentlist',11)}}">Blood test</a></h5>
                            <p>Nam libero tempore cumas soluta eligendi </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 team-type">
                        ...
                        <div class="member-content">
                            <div class="member-name">
                                <h6>{{$item->name}}</h6>
                                <p>@foreach($region as $i)
                                {{ $i->id == $item->region_id ?
                                "$i->name" : '' }}
                                @endforeach</p>
                                <p>@foreach($hospital as $value)
                                {{ $value->id == $item->hospital_id ?
                                "$value->name" : '' }}
                                @endforeach</p>
                                 <p>@foreach($department as $value)
                                {{ $value->id == $item->department_id ?
                                "$value->name" : '' }}
                                @endforeach</p>
                            </div>
                    ...
                    <div class="counter-app">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="statistics-box">
                                <i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-1.png')}}"></i>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="statistics-box">
                                <i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-2.png')}}"></i>
                                <div class="statistics-content">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="statistics-box">
                                <i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-3.png')}}"></i>
                                <div class="statistics-content">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <div class="statistics-box">
                                <i class="statistics-icon"><img alt="statistics-icon" src="{{asset('public/frontend/images/icon-4.png')}}"></i>
                                <div class="statistics-content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <article class="col-md-6 col-sm-12 col-xs-12">
                        <div class="entry-header">
                            <div class="entry-cover">
                                <a href="blog-post.html"><img src="{{asset('public/frontend/images/latest-news-1.jpg')}}" alt="latest-news"/></a>
                    ...
                    <article class="col-md-6 col-sm-12 col-xs-12">
                        <div class="entry-header">
                            <div class="entry-cover">
                                <a href="blog-post.html"><img src="{{asset('public/frontend/images/latest-news-2.jpg')}}" alt="latest-news"/></a>
                                <a href="blog-post.html" class="read-more"><i class="fa fa-link"></i>Read More</a>
                            </div>
                        </div>
                        <div class="entry-content">
